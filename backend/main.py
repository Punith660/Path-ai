...
app.add_middleware(
    ...
    allowed_hosts=[h.strip() for h in os.getenv("ALLOWED_HOSTS", "localhost,[IP_ADDRESS],testserver,https://pathai-resume-verification-tool.onrender.com").split(",") if h.strip()],
)
